...
for (const [source, fragment] of [
  ...
  [renderWorldSource, "drawSourceColorCycleOverlay(overlayGraphics, world, bounds)"],
  [renderWorldSource, "if (drewOverlayGraphics)"],
  [renderWorldSource, "function drawSourceColorCycleOverlay(graphics: Graphics, world: WorldState, bounds: MapTileRenderBounds): boolean"],
  [renderWorldSource, "let drewOverlay = false"],
  [renderWorldSource, "drewOverlay = true"],
  [renderWorldSource, "function drawSourcePassabilityOverlay(graphics: Graphics, world: WorldState, bounds: MapTileRenderBounds): boolean"],
  [renderWorldSource, "function drawSourceMapGrid(graphics: Graphics, world: WorldState, bounds: MapTileRenderBounds): boolean"],

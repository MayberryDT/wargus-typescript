...
for (const [label, text, fragments] of [
  ...
  ["orders build action", ordersSource, [
    ...
    "phase: \"to-site\"",
    "targetId: null",
    "function startBuildingFoundation",
    ...
    "planBuilding(world, builder, buildingDefinition, tileX, tileY, { clearQueue: false })",
    ...
    "canIssueBuildOilPlatformAt(world, unit, oilPatch, world.unitDefinitions)",
    "startOilPlatformConstruction(world, unit, oilPatch, player, platformDefinition, { clearQueue: !preserveQueue })",
    "function failPendingConstructionAtArrival",

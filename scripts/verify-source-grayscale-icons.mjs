...
for (const [sourceName, sourceText, fragment] of [
  ...
  ["orders", ordersSource, "export function sourceTrainButtonsForHud"],
  ["orders", ordersSource, "export function sourceResearchButtonsForHud"],
  ["orders", ordersSource, "export function sourceBuildButtonsForHud"],
  ["orders", ordersSource, ".filter((button) => sourceButtonVisibleForHud(world, button, playerId))"],
  ["orders", ordersSource, "export function sourceButtonVisibleForHud"],
  ["orders", ordersSource, "export function sourceButtonHasExecutableContext"],
  ["orders", ordersSource, "return typeof button.value === \"string\" && canTrainUnitAt(world, unit.id, button.value);"],
  ["orders", ordersSource, "return typeof button.value === \"string\" && canResearchUpgradeAt(world, unit.id, button.value);"],
  ["orders", ordersSource, "return typeof button.value === \"string\" && canStartSourceBuildPlacementByType(world, unit, button.value);"],
  ...
  ["hud", hudSource, "sourceButtonVisibleForHud(world, button, unit.player)"],
  ["hud", hudSource, "sourceButtonHasExecutableContext(world, button, unit, extraScopes)"],

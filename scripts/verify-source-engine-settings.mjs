...
const fragments = [
  ...
  [indexSource, "if (scriptFile === \"scripts/stratagus.lua\" && /RevealMap\\(\\s*\"/.test(source)) engineSettings.revealMapMode = parsedEngineSettings.revealMapMode"],
  ...
  [worldSource, "function normalizePlayableRevealMapMode"],
  [worldSource, "engineSettings.revealMapMode = \"hidden\";"],
  ...
  [renderWorldSource, "function fogTransitionTouchesVisibleTile"],
  [renderWorldSource, "const sourceVisible = world.visibleTiles[index] === 1;"],
  [renderWorldSource, "sourceVisible && sourceKnown && fogAtlas && sourceFogTiles.fogTile"],
  [renderWorldSource, "const suppressUnknownTransition = fogTransitionTouchesVisibleTile(world, x, y);"],
  [renderWorldSource, "if (!suppressUnknownTransition) {\n        fogTileIndex |= mask;"],
  [renderWorldSource, "function shouldDrawSourceBlackFogTile"],
  [renderWorldSource, "return sourceVisible || !fogTransitionTouchesVisibleTile(world, x, y);"],
  [renderWorldSource, "sourceFogTiles.blackFogTile && shouldDrawSourceBlackFogTile(world, x, y, sourceVisible)"],
  [renderWorldSource, "function isFogTileExplored"],
  [renderWorldSource, "function isFogTileVisible"],
  [renderWorldSource, "sprite.alpha = alpha"],
  [renderWorldSource, "getFogTexture(fogAtlas"],

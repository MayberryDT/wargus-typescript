...
for (const fragment of [
  ...
  "function sourceSimulationBacklogSecondsForSave",
  ...
  "const sourceScriptLaunches = normalizeAiSourceScriptLaunches",
  ...
  "normalizeBoundedAiUnitIds(record?.assignedUnitIds",
  "for (const contract of bounds.launches)",
  "normalizeBoundedAiUnitIds(record.unitIds",
  "usedUnitIds.has(unitId) || liveUnits.get(unitId)?.typeId !== target.unitTypeId",
  ...
  "function normalizeWorldPointOrNull(world: WorldState, value: unknown)",
  ...
  "function savedPathPointsAreFinite",
  "function isLoadedBuildingTile",
  "phase: \"constructing\"",
  "if (record.phase !== undefined && record.phase !== \"constructing\")",
  "normalizeLoadedBuildOrderMetadata(world, unit)",
  "function normalizeLoadedBuildOrderMetadata",
  "target.construction.builderId !== unit.id",
  "order.phase === \"constructing\" && (!order.targetId || !liveUnitIds.has(order.targetId))",
  "export function loadSavedGameJson",

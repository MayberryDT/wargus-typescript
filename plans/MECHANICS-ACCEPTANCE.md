...
| M10 | 015 | fixture-assisted completed prerequisite tiers | Open advanced pages and complete each production/conversion path | Church/Altar, Tower/Temple, Inventor/Alchemist are buildable; every advertised advanced unit is reachable | Command-card reason before/after prerequisite, queue/completion unit ids |
